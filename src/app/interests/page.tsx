...
const InterestTile = ({ id, name, selected, disabled, onToggle }: InterestTileProps) => {
  ...
  return (
    <button
      ...
      className={`
        h-12 rounded-3 border-2 font-600 text-sm transition-all duration-200 min-h-[44px]
...
const TileSkeleton = () => (
  <div className="h-12 rounded-3 bg-gray-200/60 animate-pulse" />
);
              ...
              {onboardingLoading && availableInterests.length === 0 ? (
                ...
                <>
                  ...
                  <div className="pt-6 space-y-4">
                    ...
                    <button
                      className={`
                        group block w-full text-white font-urbanist text-sm md:text-base font-600 py-3.5 md:py-4 px-6 md:px-8 rounded-3 shadow-lg transition-all duration-300 relative text-center
                        ${canProceed
