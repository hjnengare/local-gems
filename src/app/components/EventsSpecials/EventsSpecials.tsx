      ...
      <div className="container mx-auto max-w-[1300px] px-4 relative z-10 py-16">
        <div className="mb-12 flex flex-wrap items-center justify-between gap-[18px]">
          <h2 className="font-urbanist text-3xl font-800 text-charcoal relative">
            {title}
            <div className="absolute -bottom-2 left-0 w-12 h-1 bg-gradient-to-r from-coral to-sage rounded-full" />
          </h2>
          <button 
            onClick={handleSeeMore}
            className="group font-urbanist font-700 text-charcoal/70 transition-all duration-300 hover:text-coral hover:scale-105 text-sm"
          >
