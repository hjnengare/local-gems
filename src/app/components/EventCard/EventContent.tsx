  ...
  return (
    <div className="p-4 relative flex-1 flex flex-col justify-between">
      ...
      <div className="space-y-2">
        {/* Event title */}
        <h3 className="font-urbanist text-base font-600 text-charcoal transition-colors duration-200 group-hover:text-sage line-clamp-2">
        ...
        {/* Location */}
        <p className="font-urbanist text-sm font-400 text-charcoal/70 transition-colors duration-200 group-hover:text-charcoal/80 line-clamp-1 flex items-center">
